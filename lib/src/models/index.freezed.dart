...
class _$PersistentStateTearOff {
  ...
  PersistentState$ call({Bundle bundle = const Bundle(), String? walletPrivateKey, String? masterKeyHash}) {
...
class _$PersistentState$ implements PersistentState$ {
  const _$PersistentState$({this.bundle = const Bundle(), this.walletPrivateKey, this.masterKeyHash});
  ...
  int get hashCode => Object.hash(runtimeType, const DeepCollectionEquality().hash(bundle),
      const DeepCollectionEquality().hash(walletPrivateKey), const DeepCollectionEquality().hash(masterKeyHash));
...
abstract class PersistentState$ implements PersistentState {
  const factory PersistentState$({Bundle bundle, String? walletPrivateKey, String? masterKeyHash}) = _$PersistentState$;
